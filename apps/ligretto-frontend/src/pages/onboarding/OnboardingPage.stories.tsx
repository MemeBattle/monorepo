...
export const Step16_OpponentTurnSecondCard: Story = storyForStep(OnboardingStep.OpponentTurnSecondCard)
export const Step16a_OpponentTurnCycledInfo: Story = storyForStep(OnboardingStep.OpponentTurnCycledInfo)
export const Step17_FinalLigrettoCard: Story = storyForStep(OnboardingStep.FinalLigrettoCard)
export const Step18_Result: Story = storyForStep(OnboardingStep.Result)
