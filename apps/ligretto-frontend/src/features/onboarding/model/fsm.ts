...
import type { GameResults, Player } from '@memebattle/ligretto-shared'
  ...
  constructor() {
    super({
      ...
      transitions: [
        ...
        t(OnboardingStep.OpponentTurn, OnboardingEvent.PutLigretto, OnboardingStep.Result, {
          onEnter(ctx) {
        ...
        t(OnboardingStep.OpponentTurnCycledInfo, OnboardingEvent.PutLigretto, OnboardingStep.Result, {
          onEnter(ctx) {
            ctx.data.results = ONBOARDING_HARDCODED_RESULTS
          },
        }),
