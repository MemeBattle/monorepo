...
describe('card-owned hotkeys', () => {
  it('routes a rendered row key through the same toggle behavior as pointer activation', () => {
  ...
  it('routes X and pointer activation through the same open-card toggle behavior', () => {
    mocks.stackCards = []
