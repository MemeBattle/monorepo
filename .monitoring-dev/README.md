...
4. On page http://0.0.0.0:3000/dashboards press 'New' -> import
5. Select some dashboard template (e.g. apps/ligretto-gameplay-backend/.monitoring-dev/dashboard.json)
6. Select prometheus datasource and press `import`
